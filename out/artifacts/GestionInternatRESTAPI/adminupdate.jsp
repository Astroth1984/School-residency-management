                ...
                <div class="card">
                    <form class="form-horizontal" method="post" action="./AdminUpdate">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="gender" class="col-sm-4 text-right control-label col-form-label">Gender</label>
                                <div class="col-sm-8">
                                    <input type="text" name="gender" class="form-control" id="gender" placeholder="Room ID Here">
                                </div>
                            </div>
                            <br/>
                        </div>
